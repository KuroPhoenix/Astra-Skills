...
| `cm-design-and-visual-21` | `diagram` | skill | live | Design & visual | independent reference | retained independent | `astra-document` and `astra-interface`: consume editable-artifact output; `astra-report`: post-MVP supplemental-delivery consumer | claimed | [Roadmap amendment 3 §10](design-roadmap.md#10-amendment-3--wave-1-design--visual-source-triage); [Astra Report §4.3](../designs/astra-report.md#43-post-mvp-delivery-adapters). |
...
| `cm-docs-and-knowledge-01` | `document-generate` | skill | live | Docs & knowledge | independent reference | independent | `astra-report`: explanation-quadrant structure slice | claimed | [Astra Report §4.1–§4.2](../designs/astra-report.md#41-occurrence-inspection-record): approved lock exception; the resolver gap remains before resolution. |
| `cm-docs-and-knowledge-02` | `doc-coauthoring` | skill | live | Docs & knowledge | independent reference | independent | `astra-report`: chunking and fresh-reader-testing playbook slice | claimed | [Astra Report §4.1–§4.2](../designs/astra-report.md#41-occurrence-inspection-record). |
| `cm-docs-and-knowledge-03` | `/doc` | command | live | Docs & knowledge | independent reference | independent | `astra-report`: plain-language, audience-targeting, and fresh-reader-test slice | claimed | [Astra Report §4.1–§4.2](../designs/astra-report.md#41-occurrence-inspection-record): approved lock exception. |
| `cm-docs-and-knowledge-04` | `make-pdf` | skill | live | Docs & knowledge | independent reference | independent | `astra-report`: post-MVP delivery adapter | claimed | [Astra Report §4.1–§4.3](../designs/astra-report.md#41-occurrence-inspection-record). |
| `cm-docs-and-knowledge-05` | `internal-comms` | skill | live | Docs & knowledge | independent reference | independent | `astra-report`: status/leadership/FAQ register slice | claimed | [Astra Report §4.1–§4.2](../designs/astra-report.md#41-occurrence-inspection-record). |
| `cm-docs-and-knowledge-06` | `learn` | skill | live | Docs & knowledge | unassigned | unassigned | — | unclaimed | Pending source inspection. |
| `cm-docs-and-knowledge-07` | `teach` | skill | live | Docs & knowledge | independent reference | independent | `astra-report`: working-memory chunk-sizing slice | claimed | [Astra Report §4.1–§4.2](../designs/astra-report.md#41-occurrence-inspection-record). |
...
| `cm-docs-and-knowledge-09` | `rtfm` | skill | live | Docs & knowledge | independent reference | independent | `astra-report`: consumer-framing and uncertainty-disclosure slice | claimed | [Astra Report §4.1–§4.2](../designs/astra-report.md#41-occurrence-inspection-record): approved lock exception. |
